...
module.exports = {
    ...
    fday: (date) => {
        return moment(date).tz("Asia/Jakarta").format('dddd')
    },

    fdate: (date) => {
        return moment(date).tz("Asia/Jakarta").format('dddd, DD MMM YYYY')
    },
